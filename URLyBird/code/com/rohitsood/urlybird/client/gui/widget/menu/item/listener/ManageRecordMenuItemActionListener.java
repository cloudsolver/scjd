  ...
  /**
   * The listner implementation for listening to user action on the <tt>ManageRecordMenuItem</tt>.
   * Calls are delegated to the <tt>GuiManager</tt> for execution.
   *
   * @author Rohit Sood
   * @version 1.1
   */
  public class ManageRecordMenuItemActionListener implements ActionListener
  {
