  ...
  /**
   * This is a standard form consisting of labels and corresponding text fields. Provides the basic
   * structure and behavior of a data panel. This is the super class of all panels in the user interface.
   * Panels that represent entire data set or a sub-set of the data must extend from this class.
   *
   * @author Rohit Sood
   * @version 1.1
   */
  abstract class DataPanel extends JPanel
  {
      ...
      /**
       * Initializes the panel for the user iterface. Lays out the user interface, sets the preferred size
       * and adds widgets.
       */
      protected void init()
      {
          ...
          SpringLayoutUtilities.makeSpringGrid(this, orientation.getRowCount(),
              orientation.getColumnCount(), SpringLayoutUtilities.SPREAD, SpringLayoutUtilities.SPREAD,
              SpringLayoutUtilities.SPREAD, SpringLayoutUtilities.SPREAD);
      ...
      /**
       * Clears all text fields of all data.
       */
