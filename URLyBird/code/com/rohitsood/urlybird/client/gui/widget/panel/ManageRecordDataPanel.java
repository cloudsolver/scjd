  ...
  /**
   * Creates the panel to hold the user interface which lets the agent manage the room records.
   * Buttons are provided to add, update (save), and delete. Also a quick search by record id functionality.
   * This user interface intended to be used by adminstrators.
   * Adminstrators may modify available records, delete customer bookings and look up records quickly.
   * @author Rohit Sood
   */
  public class ManageRecordDataPanel extends DataPanel
  {
      ...
      /**
       * Accessor for the id text field.
       * Once a reference is obtained, the text field can be manipulated to be enabled or disabled.
       *
