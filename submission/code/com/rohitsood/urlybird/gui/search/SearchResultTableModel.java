...
/**
 * Holds the search result data in the <tt>TableModel</tt>. Tracks the record id, defines the column names and
 * convenience methods. Table columns are defined which contain all data columns including record id.
 *
 * @author Rohit Sood
 * @version 1.1
 */
public class SearchResultTableModel extends AbstractTableModel {
    ...
    private static String[] colNames = { "Rec Id", "Hotel", "City", "Max Cap", "Smoking", "Price", "Date", "Cust ID" };

    /** The list of records returned. */
    private List dataList;

    /**
     * Creates a new <tt>SearchResultTableModel</tt> object.  Registers this with the <tt>GuiManager</tt>.
     *
    ...
    /**
     * Creates a new data record with the first object in the array as the record id. Sets the record id at index zero.
     *
    ...
    /**
     * Accessor for the object at a given row and column This will ignore the column index and return the id as an
     * Integer.
     *
    ...
    /**
     * Accessor for the column name. The model provides the name of the column given the column index.
     *
    ...
    /**
     * Returns the column count. Counts the number of columns in the table model and returns the size.
     *
