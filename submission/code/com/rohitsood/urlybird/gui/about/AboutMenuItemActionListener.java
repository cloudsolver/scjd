...
/**
 * The listener implementation for listening to user action on the <tt>PreferencesMenuItem</tt>.
 * Calls are delegated to the <tt>GuiManager</tt> for execution.
 *
 * @author Rohit Sood
 * @version 1.1
 */
  class AboutMenuItemActionListener implements ActionListener
  {
       /**The manager to delegate to. */
      private GuiManager manager;

      /**
       * Creates a new PreferencesMenuItemActionListener object.
       *
       * @param manager The manager to delegate to.
       */
      public AboutMenuItemActionListener(GuiManager manager)
      {
