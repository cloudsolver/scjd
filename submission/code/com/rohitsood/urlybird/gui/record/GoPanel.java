...
/**
 * User interface component that allows the user to enter a record id and hit a 'Go' button. A quick search by id is
 * made possible by this user interace.
 *
 * @author Rohit Sood
 * @version 1.1
 */
public class GoPanel extends JPanel {
    ...
    private static final int RIGID_AREA_HEIGHT = 35;
    ...
    private void init() {
        ...
        final CommonButton goButton = new CommonButton(GO_TEXT);
        goButton.addActionListener(new GoButtonActionListener(this.manager));

        final Box verticalBox = Box.createVerticalBox();
        add(verticalBox);

        final Dimension rigidDimension = new Dimension(RIGID_AREA_WIDTH, RIGID_AREA_HEIGHT);
        ...
        setPreferredSize(SpringLayoutUtilities.getPreferredDimension(this, SpringLayoutUtilities.HORIZONTAL));
    }
